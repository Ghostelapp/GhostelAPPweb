...
export default function Sidebar() {
  ...
  const items = [
    ...
    { to: "/admin/support", icon: LifeBuoy, label: t("admin.support"), testid: "sidebar-support" },
    { to: "/admin/error-logs", icon: AlertTriangle, label: "Error logs", testid: "sidebar-error-logs" },
