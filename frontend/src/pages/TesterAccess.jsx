...
const ANDROID_APK_URL =
  "https://expo.dev/artifacts/eas/Y_Csd6AKlOmGD34xEL5us5-V7EYyktGVBfhM_FXvpmA.apk";
const IOS_BUILD_URL =
  "https://expo.dev/accounts/coda666/projects/ghostel/builds/0df7cf55-051e-4c8c-9043-27a71ea64169";
          ...
          <div className="relative mx-auto max-w-6xl">
            ...
            <div className="mb-8 grid gap-6 lg:grid-cols-2">
              <section className="glass rounded-3xl p-6">
                ...
                <h2 className="font-display text-3xl font-bold">Android 1.4.25 (25)</h2>
                <p className="mt-3 text-zinc-400">
                  Pobierz plik APK, zezwól na instalację z tego źródła i uruchom aplikację.
                </p>
                <div className="mt-6 flex flex-wrap gap-3">
                  <Button asChild className="h-11 rounded-xl bg-gradient-to-r from-cyan-400 to-fuchsia-500 px-5 font-semibold text-zinc-950 hover:opacity-95">
              ...
              <section className="glass rounded-3xl p-6">
                ...
                <h2 className="font-display text-3xl font-bold">iOS 1.4.25 (21)</h2>
                <p className="mt-3 text-zinc-400">
                  Na iOS testy odbywają się przez TestFlight. Najpierw zainstaluj TestFlight,
                  potem otwórz zaproszenie do testów, które otrzymasz od zespołu Ghostel.
                </p>
                <div className="mt-6 flex flex-wrap gap-3">
                  <Button asChild variant="outline" className="h-11 rounded-xl border-white/10 bg-white/5 px-5 text-white hover:bg-white/10">
                  ...
                  <Button asChild variant="outline" className="h-11 rounded-xl border-white/10 bg-white/5 px-5 text-white hover:bg-white/10">
                    <a href={IOS_BUILD_URL} target="_blank" rel="noreferrer">
                      Zobacz build iOS
                      <ExternalLink className="ml-2 h-4 w-4" />
                    </a>
                  </Button>
