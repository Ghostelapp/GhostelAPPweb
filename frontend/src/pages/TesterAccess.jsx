...
const ANDROID_APK_URL = "https://api.ghostel.app/app-release.apk?v=1.4.42";
const TESTFLIGHT_APP_URL = "https://apps.apple.com/app/testflight/id899247664";
const TESTER_APP_VERSION = "1.4.42";
const TESTER_ANDROID_BUILD = "42";
const TESTER_IOS_BUILD = "38";
