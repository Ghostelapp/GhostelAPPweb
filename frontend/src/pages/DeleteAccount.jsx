    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <main className="max-w-4xl mx-auto px-6 lg:px-8 pt-32 pb-20">
        <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-cyan-400 mb-4">
          {isPl ? "Konto Ghostel" : "Ghostel account"}
        </p>
        <h1 className="font-display text-4xl sm:text-5xl font-extrabold tracking-tight mb-5">
          {isPl ? "Usuwanie konta i danych" : "Account and data deletion"}
        </h1>
        <p className="text-zinc-400 leading-relaxed mb-12">
          {isPl
            ...
            : "A Ghostel account can be deleted directly in the app. The operation is permanent and requires signing in to the account that should be deleted."}
        </p>

        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-6">
          <section className="surface rounded-2xl p-7">
            <h2 className="font-display text-xl font-bold text-white mb-5">
              {isPl ? "Jak usunąć konto" : "How to delete your account"}
            </h2>
          ...
          <section className="surface rounded-2xl p-7">
            <h2 className="font-display text-xl font-bold text-white mb-5">
              {isPl ? "Co zostanie usunięte" : "What gets deleted"}
            </h2>
            <ul className="list-disc pl-5 space-y-2 text-zinc-300">
              <li>{isPl ? "Profil, e-mail, nazwa, avatar i ustawienia konta." : "Profile, email, name, avatar and account settings."}</li>
              <li>{isPl ? "Tokeny push i dane urządzeń." : "Push tokens and device data."}</li>
              <li>{isPl ? "Kontakty, zaproszenia i blokady." : "Contacts, invitations and blocks."}</li>
              <li>{isPl ? "Prywatne załączniki i historia połączeń." : "Private attachments and call history."}</li>
            </ul>
          </section>
        </div>
        ...
        <section className="surface rounded-2xl p-7 mt-6">
          <h2 className="font-display text-xl font-bold text-white mb-3">
            {isPl ? "Co może zostać zachowane" : "What may remain"}
          </h2>
