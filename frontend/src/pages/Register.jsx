...
export default function Register() {
  ...
  return (
    <div className="min-h-screen relative grid place-items-center bg-zinc-950 overflow-hidden p-6">
      ...
      >
        <Link to="/" className="text-xs text-zinc-500 hover:text-cyan-400 mb-6 inline-block">
          {t("login.backHome")}
        </Link>
        ...
        <p className="text-sm text-zinc-400 mb-8">Join Ghostel today.</p>
        ...
        <form onSubmit={onSubmit} className="space-y-5">
          ...
          {error && (
            <div data-testid="register-error" className="text-xs text-red-400 bg-red-500/10 border border-red-500/20 rounded-lg px-3 py-2">
              {error}
            </div>
          )}
