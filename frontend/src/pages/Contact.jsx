...
const copy = {
  pl: {
    ...
    title: "Skontaktuj sie z Ghostel Support",
    intro: "Opisz problem mozliwie konkretnie. Zgloszenie trafi do panelu administracyjnego i bedzie obslugiwane przez zespol Ghostel.",
    name: "Imie lub nazwa",
    ...
    sending: "Wysylanie...",
    successTitle: "Zgloszenie zostalo przyjete",
    ticket: "Numer zgloszenia",
    backHome: "Wroc na strone glowna",
    response: "Zwykle odpowiadamy w 24-48 godzin.",
    security: "Nie wysylaj hasel, kodow SMS ani prywatnych kluczy.",
